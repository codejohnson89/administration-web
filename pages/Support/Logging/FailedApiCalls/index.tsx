    ...
    return (
        <>
            <section className="content-wrapper">
                <PageHeaderWithOutButton header="Failed API Calls" />
                    ...
                    <div className={styles.formFields}>
                        ...
                        <Row>
                            <Form.Group className={["col-sm-4", styles.formInput].join(' ')}>
                                ...
                                <Form.Control className={styles.formInput} type="text" {...register("StatusCode")}/>
                            </Form.Group>
                            <Form.Group className={["col-sm-4", styles.formInput].join(' ')}>
                        ...
                        <Row>
                            ...
                            <Form.Group className={["col-sm-4", styles.formInput].join(' ')}>
                                ...
                                <Form.Select {...register("PaymentChannel")}>
                                    <option value="">Any</option>
                                    <option value="yes">Yes</option>
                                    <option value="no">No</option>
                                </Form.Select>
