    ...
    return (
        <>
            <section className="content-wrapper">
                <PageHeaderWithOutButton header="Authentication Request Index"/>
                    ...
                    <div className={styles.formFields}>
                        ...
                        <Row>
                            ...
                            <Form.Group className={["col-sm-4", styles.formInput].join(' ')}>
                                ...
                                <Form.Control className={styles.formInput} type="text" {...register("AuthenticateResponseId")}/>
                            </Form.Group>
                        </Row>
